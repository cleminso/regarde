# INTERFACE-GUIDELINES.md - UI Development & Tailwind CSS
...
- Implement proper variants for different states (hover, focus, disabled)
...
Follow the patterns from [interfaces.rauno.me](https://interfaces.rauno.me):

- Implement consistent spacing patterns
- Use standardized color palettes
- Follow established component architectures
- Maintain consistent interaction states

### Customization for Regarde

While following interfaces patterns, customize for Regarde's specific needs:

- Ensure accessibility remains high priority
- Implement proper focus management for auth flows
- Provide clear visual feedback for authentication states
- Maintain consistent branding elements across components
