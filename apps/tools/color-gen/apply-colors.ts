 ...
 *
 * - Updates the --color-* variables in index.css
...
const stylesDir = resolve(import.meta.dirname!, '../../dashboard.regarde.dev/src')
...
// ---------------------------------------------------------------------------
// 2. Update --color-* vars in index.css
// ---------------------------------------------------------------------------

const mainCssPath = resolve(stylesDir, 'index.css')
...
console.log(`Updated ${updated} colour variable(s) in index.css`)
