...
export function WebhookList({
  ...
  return (
    <div className="w-full h-full overflow-hidden bg-card">
      {/* Header */}
      <div className="flex h-9 items-center border-b border-border bg-background px-4 py-2">
        ...
        <div className="flex w-20 items-center justify-center shrink-0">
          <span className="text-sm font-mono text-muted-foreground">Provider</span>
        </div>
        <div className="flex w-24 items-center justify-center shrink-0">
          <span className="text-sm font-mono text-muted-foreground">Environment</span>
        </div>
        <div className="flex w-40 items-center min-w-0">
          <span className="text-sm font-mono text-muted-foreground">Secret</span>
        </div>
