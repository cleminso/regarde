 ...
 */
export const API_BASE_URL = import.meta.env.VITE_REGARDE_API_URL || "https://api.regarde.dev";
 ...
 */
export const getWebhookUrl = (provider: TPaymentProvider, appId: string): string => 
  `${API_BASE_URL}/webhooks/${provider}/${appId}`;
...
export const getWebhookUrlPreview = (provider: TPaymentProvider): string =>
  `${API_BASE_URL}/webhooks/${provider}/[app-id]`;
