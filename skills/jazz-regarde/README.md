...
- **React Integration**: Hooks for reactive UI
...
| `react-hooks/`        | useAccount, useCoState, useRegardeAuth, useRegardeTokenAuth  | [README](./references/react-hooks/README.md) (useRegardeAuth: React only)                  |
...
- **useRegardeAuth**: React hook for passphrase authentication with BIP39 wordlist
- **useRegardeTokenAuth**: React hook for token management (API)
