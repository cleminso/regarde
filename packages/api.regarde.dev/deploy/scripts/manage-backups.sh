...
# =============================================================================
# API Server Backup Management Tool
# =============================================================================
# This script manages backups created by the deployment script
# Usage: ./packages/api.regarde.dev/deploy/scripts/manage-backups.sh [command]
#
...
# Script header
log_header "API Server Backup Management" "Manage deployment backups"
